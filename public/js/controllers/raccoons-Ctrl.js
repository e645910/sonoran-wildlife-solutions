angular.module('sws')
    .controller('raccoonsController', function($scope) {
        ...
        $scope.slides = [
            ...
            { image: '/img/raccoons/spottedSkunk.jpg', name: 'Spotted Skunk', text: 'Skunks are critters that need to be handled with care for very obvious reasons.  their primary mission in life is finding food. '},
